	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="bigdap" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 Copyright © 2018-2020 中国科学院软件研究所 All Rights Reserved 版权所有
</div>
<!-- END COPYRIGHT -->
